...
const navItems: NavItem[] = [
  ...
  { href: "/admin/finance", label: "الرواتب والدعم", icon: Wallet },
  { href: "/admin/messages", label: "رسائل اليوم", icon: MessageSquare },
  { href: "/admin/story", label: "قصة اليوم", icon: ImageIcon },
  { href: "/admin/themes", label: "الثيمات", icon: Paintbrush },
  { href: "/admin/notifications", label: "الإشعارات", icon: Bell },
  { href: "/admin/content", label: "الأخبار والوظائف", icon: Newspaper },
  ...
  { href: "/admin/docs", label: "التوثيق", icon: BookOpen },
];
