...
/**
 * Arabic city name → English key mapping.
 * Handles what the frontend sends (Arabic display names from useLocationPrefs).
 */
...
// Default prayer times per city (seed/fallback)
